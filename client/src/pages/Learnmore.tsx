  ...
  return (
    <div className="bg-white w-full">
      ...
      <div className="mx-auto max-w-[1000px] px-4 sm:px-6 md:px-6">
        <h1 className="[font-family:'Poppins'] font-bold text-black text-2xl sm:text-3xl text-[36px] md:text-[48px] tracking-[0] leading-tight md:leading-[48px] mt-8 md:mt-16 text-center">
          OUR STORY
        </h1>

        <p className="[font-family:'BeVietnam'] font-normal text-black text-sm sm:text-base text-[18px] md:text-[20px] tracking-[0] leading-relaxed md:leading-[30px] mt-6 md:mt-8 mb-8 md:mb-12 text-center">
