              ...
              {navigationItems.map((item, index) => {
                ...
                return (
                  <Link
                    ...
                    className={`[font-family:'Poppins'] block px-4 py-2 font-normal text-black text-[18px] tracking-[0] leading-[normal] hover:bg-gray-100 rounded-lg transition-colors ${
